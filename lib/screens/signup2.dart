...
Future addUserDetail(String birthday, String gender, String profession) async {
...
reusableTextField("Profession", Icons.person_outline, false, _professionTextController),
const SizedBox(
height: 20,
),
firebaseUIButton(context, "Save", () {
addUserDetail(_birthdayTextController.text, _genderTextController.text, _professionTextController.text);
